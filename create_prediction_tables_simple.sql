-- Script simplificado para crear las tablas de predicciones
-- Sin foreign keys para evitar errores de migración

USE trading_db;

-- Crear tabla de predicciones de usuarios (sin foreign key)
...
-- Crear tabla de límites de predicciones por usuario (sin foreign key)
